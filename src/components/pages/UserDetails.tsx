  ...
  useEffect(() => {
    axios.get(`${url}/${id}`).then((response) => {
      ...
      if (+data.education.monthlyIncome[0] < +data.education.monthlyIncome[1]) {
        setIncomeRange({
          ...incomeRange,
          lower: +data.education.monthlyIncome[0],
          higher: +data.education.monthlyIncome[1],
        });
      } else {
        setIncomeRange({
          ...incomeRange,
          lower: +data.education.monthlyIncome[1],
          higher: +data.education.monthlyIncome[0],
        });
      }
    });
  }, []);
    ...
    <div className="userdetails-container">
...

      {
        user ? (
          <div className="profile-details-navigation">
            <div className="profile-header">
              ...
              <div className="amount-section">
                <div className="amount">₦{user.accountBalance}</div>

                <div className="account-details">9912345678/Providus Bank</div>
              </div>
            </div>
          ...
          <div className="lds-ring loadEffect">
            <div></div>
            <div></div>
            <div></div>
            <div></div>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {" "}
                        ₦{incomeRange.lower}-{incomeRange.higher}
                      </td>
